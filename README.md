...
- Transport groups (1px `#222` 40% separators) on solid `#050505`: rewind · play · **stop** · fast-forward | speaker + **horizontal** volume slider + numeric | lime timecode | hamburger (**보기**). **CC** and fullscreen are off the bar. Button padding 4. I/O marks are 2px lime squares (not ellipses). No ±10 on the bar — ±10 lives in **퀵메뉴**. No Cast / HDR / Eject
