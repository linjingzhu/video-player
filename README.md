...
- Transport groups (1px `#222` 40% separators) on solid `#050505`: rewind · play · **stop** · **지우기** · fast-forward | speaker + **horizontal** volume slider + numeric | lime timecode | hamburger (**보기**). **지우기** unloads the current title, persists resume as usual, and empties the stage (no last frame). Text label, not a Windows eject/Cast icon. **CC** and fullscreen are off the bar. Button padding 4. I/O marks are 2px lime squares (not ellipses). No ±10 on the bar — ±10 lives in **퀵메뉴**. No Cast / HDR / Eject
