...
- Transport groups (1px `#222` 40% separators) on solid `#050505`: rewind · play · **stop** · **지우기** · fast-forward | speaker + **horizontal** volume slider + numeric | lime timecode | hamburger (**보기**). **지우기** sits immediately right of Stop as the text label **지우기** (not an eject glyph). It unloads the current title (file or http(s)), saves resume at the **current position** and never marks complete, and empties the stage (no last frame). **CC** and fullscreen are off the bar. Button padding 4. I/O marks are 2px lime squares (not ellipses). No ±10 on the bar — ±10 lives in **퀵메뉴**. No Cast icon / HDR / Eject
