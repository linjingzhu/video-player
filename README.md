...
- **Enter** and **F11** toggle fullscreen vs windowed. Fullscreen transport is a floating overlay at `#050505` / 80% opacity. Windowed transport stays docked. Existing 3s idle hide still applies in fullscreen while playing (chrome stays when paused).
