...
Invoke in Codex with `$auto-dev`. Use the Codex agent definitions and model
selection in `.ai/HARNESS.md` § *Codex capabilities and model routing*;
the workflow and gates below follow the Claude skill.
